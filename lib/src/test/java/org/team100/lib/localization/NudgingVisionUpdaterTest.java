...
public class NudgingVisionUpdaterTest {
    ...
    void testZeroNudge() {
        ...
        IsotropicNoiseSE2 visionStdDev = new IsotropicNoiseSE2(0.02, 0.02);
    ...
    void testGentleNudge() {
        int frameRate = 50;
        IsotropicNoiseSE2 stateStdDev = new IsotropicNoiseSE2(0.001, 0.1);
        IsotropicNoiseSE2 visionStdDev = new IsotropicNoiseSE2(0.1, Double.MAX_VALUE);
        final Pose2d sample = new Pose2d();
    ...
    void testFirmerNudge() {
        int frameRate = 50;
        IsotropicNoiseSE2 stateStdDev = new IsotropicNoiseSE2(0.001, 0.1);
        IsotropicNoiseSE2 visionStdDev = new IsotropicNoiseSE2(0.03, Double.MAX_VALUE);
        final Pose2d sample = new Pose2d();
        final Pose2d measurement = new Pose2d(0.1, 0, new Rotation2d());
        Pose2d nudged = sample;
        for (int i = 0; i < frameRate; ++i) {
